    ...
    <div className="fixed inset-0 w-full max-w-[600px] h-screen bg-[url('/img/도치편지지.jpg')] bg-center bg-no-repeat bg-cover mx-auto ">
      ...
      <div className="my-6 mx-3">
        ...
        <form
          ...
          <input
            {...register('nickname')}
            className="w-full p-2 border border-black/30 rounded-lg focus:bg-blue-100 focus:outline-none"
            placeholder="무슨 닉네임으로 보내고 싶나요?"
          />

          <textarea
            {...register('content')}
            className="w-full h-60 p-3 border border-black/30 rounded-lg focus:bg-blue-100 focus:outline-none"
